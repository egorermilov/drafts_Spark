...
object ArticleSimilaritiesGraph {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val sc = new SparkContext("local[*]", "ArticleSimilaritiesGraph")
    ...
    println("partialGraph ::")
    val partialGraph = ratings.join(ratings)
...
//      .foreach(println)
    ...
    println("finalGraph ::")
    val finalGraph = partialGraph
      .join(totalGraph)
      .map(x => ((x._1, x._2._1._1), x._2._1._2.toFloat / x._2._2.toFloat))
      .take(5000)
      .foreach(println)
